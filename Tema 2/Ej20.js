...
function menu() {
    ...
    function j() {
        ...
        */
        ...
        //¿para que hacer la función flecha si ya tenemos una función .fill() que lo haga?
        //arrayAuxiliar.forEach(elemento => arrayAuxiliar[6])

        arrayAuxiliar.fill(6)
        alert(numsIntroducidos + " El array queda asi: " + arrayAuxiliar)
    }
    ...
    function l(){
        let arrayAuxiliar = numsIntroducidos.slice()
        arrayAuxiliar = arrayAuxiliar.sort()
        arrayAuxiliar = arrayAuxiliar.reverse()
        alert(numsIntroducidos+" El array ordenado de menor a mayor es: "+arrayAuxiliar)
    }
    ...
    function l(){
        let arrayAuxiliar = numsIntroducidos.slice()
        for (let m = 0; m < arrayAuxiliar.length; m++) {
            for (let n = 0; n <= arrayAuxiliar.length - m - 1; n++) {
                if (arrayAuxiliar[n]>arrayAuxiliar[n+1]){
                    let aux = arrayAuxiliar[n]
                    arrayAuxiliar[n] = arrayAuxiliar[n+1]
                    arrayAuxiliar[n+1] = aux
                }
            }
        }
        alert(numsIntroducidos + " El array se queda ordenado de mayor a menor: "+arrayAuxiliar)
    }
